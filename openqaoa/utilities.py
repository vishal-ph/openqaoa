...
def expectation_values(variational_params: QAOAVariationalBaseParams, qaoa_results: dict, qaoa_backend: QAOABaseBackend, hamiltonian: Hamiltonian, mixer_type:str, p: int, analytical: bool = True, shot_based: bool = False, shots: int = 100):
    """
    ...
    # The QAOA angles
    optimized_params = qaoa_results['final params']
